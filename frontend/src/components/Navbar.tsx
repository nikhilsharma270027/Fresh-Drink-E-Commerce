...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="z-50 flex justify-evenly items-center border-3 border-black p-2">
        <Link to="/" className="flex-none w-10 flex justify-center">
          <img
            src="can.png" className="w-210 h-8"/>
        ...
        <div className="flex justify-center items-center">
            <div className="flex justify-center items-center">
                <div className="gap-2 font-bold text-black">Cart</div>
